...
LevelSelectState::LevelSelectState(void)
	: isPressedUp(false), isPressedDown(false), isRightPressed(false), isLeftPressed(false)
{
	f = new sf::Font();
	if(f->loadFromFile("media/fonts/arial.ttf"))
	{
		...
		bM->createButton("Level 1-1", [] {});
		bM->createButton("Level 1-2", [] {});
		bM->createButton("Level 1-3", [] {});
		bM->createButton("Level 1-4", [] {});
		bM->createButton("Level 2-1", [] {});
		bM->createButton("Level 2-2", [] {});
		bM->createButton("Level 2-3", [] {});
		bM->createButton("Level 2-4", [] {});
		bM->createButton("Level 3-1", [] {});
		bM->createButton("Level 3-2", [] {});
		bM->createButton("Level 3-3", [] {});
	}
